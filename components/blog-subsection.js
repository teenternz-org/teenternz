    ...
    <>
      <div className="hidden sm:block fixed">
        ...
        <div className="flex flex-wrap">
          <Link href="/authors/sanskriti-jain" passHref><p className="border-2 bg-gray-100 p-1 ml-4 text-sm font-medium rounded-full text-center cursor-pointer px-auto mt-6">Sanskriti Jain</p></Link>
          <Link href="/authors/delina-thatai" passHref><p className="border-2 bg-gray-100 p-1 ml-4 text-sm font-medium rounded-full text-center cursor-pointer px-auto mt-6">Delina Thatai</p></Link>
          <Link href="/authors/keshav-sharma" passHref><p className="border-2 bg-gray-100 p-1 ml-4 text-sm font-medium rounded-full text-center cursor-pointer px-auto mt-6">Keshav Sharma</p></Link>
          <Link href="/authors/janhavi-inamdar" passHref><p className="border-2 bg-gray-100 p-1 ml-4 text-sm font-medium rounded-full text-center cursor-pointer px-auto mt-6">Janhavi Inamdar</p></Link>
          <Link href="/authors/erik-burckhardt" passHref><p className="border-2 bg-gray-100 p-1 ml-4 text-sm font-medium rounded-full text-center cursor-pointer px-auto mt-6">Erik Burckhardt</p></Link>
        </div>
