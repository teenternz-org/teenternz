      ...
      <div className="bg-gray-900">
        <div className="grid grid-cols-5">
          ...
          <div className=" md:col-span-4 col-span-5 md:flex hidden flex-1 md:pt-0 my-auto md:space-x-6 justify-center md:justify-end mx-16">
            ...
            <Link href="/faq" passHref><div className="text-base p-2 text-white font-normal cursor-pointer">FAQ</div></Link>
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex md:hidden ml-auto mr-12 flex-col space-y-2 my-6">
            ...
            <Link href="/faq" passHref><div className="text-white cursor-pointer font-normal">FAQ</div></Link>
          </div>
        </div>
