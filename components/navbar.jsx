...
class Navbar extends Component {
  ...
  render() {
    return (
      ...
      <div className="mt-0 md:flex bg-white sm:flex hidden flex-1 md:px-12 sm:px-6 sm:py-4 md:py-4">
      ...
      <div className="-mt-20 p-7 hidden justify-center md:space-x-8 sm:space-x-4 sm:flex sm:flex-1">
      ...
      <div className="flex flex-1 bg-white justify-between sm:hidden p-6">
