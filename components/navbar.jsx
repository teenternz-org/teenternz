  ...
  render() {
    return (
      ...
      <div className="mt-0 flex bg-white sticky top-0 flex-1 md:px-12 px-6 py-4 md:py-4">
        ...
        <div className="text-black p-2 sm:hidden cursor-pointer menu-icon" onClick={this.handleClick}><svg xmlns="http://www.w3.org/2000/svg" className="sm:hidden h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
