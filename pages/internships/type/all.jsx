  ...
  return (
    ...
    <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
        ...
        <div className="text-left ml-0">
            ...
            <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
                <div className="rounded-md overflow-hidden">
                    <a href="opencallforartists.html"><img src="/org/opencallforartists.jpg" alt="logo" width="90px"
                            height="90px"/></a>
                </div>
                <div className="text-left ml-0">
            ...
            <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
                ...
                <div className="text-left ml-0">
                    <h1 className="text-lg font-medium">GENOUROUS KITCHEN</h1>
                    <p className="text-sm">Hiring
                        Members, Volunteers
                    </p>
                </div>
            ...
            <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
                ...
                <div className="text-left ml-0">
                    ...
                    <p className="text-sm">Hiring Volunteers, Interns, Members
                    </p>
                </div>
            </div>
            <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
            ...
            <div className="m-4 shadow-xl rounded-lg grid grid-cols-2 bg-purple-200">
                ...
                <div className="text-left ml-0">
                    ...
                    <p className="text-sm">Hiring Volunteers, Interns
                    </p>
                </div>
            </div>
